...
| ---------------------------------- | -------------- | -------------------------------------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Persistent-resume Git safety       | OVERRIDE       | boot-mode resolution + repository refresh          | HOT     | A provider restart can retain the filesystem while rerunning the supervisor. Never reset an established checkout; test repo-image restarts and pre-prompt restarts.                    |
