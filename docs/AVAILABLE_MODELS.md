...
| `opencode/glm-5.3`       | GLM 5.3       | Z.ai          | Not supported     | N/A            |
...
| `zai-coding-plan/glm-5.3-flash` | GLM 5.3 Flash | Z.AI Coding Plan | low, high, max    | Provider default |
| `zai-coding-plan/glm-5.3`       | GLM 5.3       | Z.AI Coding Plan | low, high, max    | Provider default |
